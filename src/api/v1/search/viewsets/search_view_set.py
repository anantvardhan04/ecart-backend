...
class SearchDocumentViewSet(BaseSearchDocumentViewSet, SuggestMixin, MoreLikeThisMixin):
    ...
    suggester_fields = {
        ...
        "name_suggest_mlt": {
            ...
            "completion_options": {"field": "name_suggester"},
            "options": {
                "size": 5,
            },
        },
    ...
    def parser_aggregations(self, aggregations_result):
        left_filter = {}
        left_filter["gender"] = aggregations_result["_filter_gender"]["gender"][
            "buckets"
        ]
        left_filter["year"] = aggregations_result["_filter_year"]["year"]["buckets"]
        left_filter["color"] = aggregations_result["_filter_baseColour"]["baseColour"][
            "buckets"
        ]
